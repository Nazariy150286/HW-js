...
const galleryModal = document.querySelector(".lightbox");
const galleryModalItem = document.querySelector(".lightbox__image");
...
document.querySelectorAll(".gallery__image").forEach((img) => {
  img.onclick = (e) => {
    ...
    galleryModalItem.src = e.target.src;
  };
});
...
document.addEventListener("keydown", (e) => {
  if (galleryModal.classList.contains("is-open")) {
    ...
    galleryModalItem.src = galleryImgs[currentIndex].src;
  }
});
